...
tree = etree.parse('/home/mbeliveau/GitRepos/keycloak/distribution/server-dist/target/keycloak-4.0.0.Beta2-SNAPSHOT/standalone/configuration/standalone.xml', parser)
root = tree.getroot()
